...
def analyze_coverage(
    ...
    a score that rewards large, nearby-but-not-too-close zones.
    ...
    for cluster in regions:
        ...
        # Gaussian: peak at 5 km from center-of-mass, width 8 km
        dist_factor = _math.exp(-((dist_km - 5.0) ** 2) / (2 * 8.0 ** 2))
